...
function PasswordRecovery() {
  ...
  const { mutate: forgetpassword, isLoading: isLoadingforgetpassword, } = useMutation((data: any) => api.post("/forgetpasswordemail", data), {
    onSuccess: (res: any) => {
                    ...
                    <form className="form">
                      <div className="form-group">
                        ...
                        <input type="email" name="mail"
                          ...
                          id="email" placeholder="Enter your email address" onChange={(e) => {
                            setEmail(e.target.value)
                          }} />
                        {error.email ? <span style={{ backgroundColor: "red" }}>{error.email}</span> : null}
                      </div>
                      <button type="submit" className="btn btn-primary btn-lg rounded" onClick={(e) => {
                        e.preventDefault(),
                          forgetpassword({
                            email: email
                          }),

...
function Section_prop({
  allPropertySubTypes, PropertySubType, setPropertySubType,
  allCities, City, setCity,
  search, setsearch,
  allCounties, CountyOrParish, setCountyOrParish,
        ...
        <div className="container">
            ...
            <div className="row align-items-lg-center" id="accordion-2">
              <div className="col-xl-2 col-lg-3 col-md-4">
                <div className="property-search-status-tab d-flex flex-row">
                  <input className="search-field" type="hidden" name="status" value="for-rent"
                    data-default-value="" />
              ...
              <div className="col-xl-8 col-lg-7 d-md-flex">
                <select value={PropertySubType} onChange={(e) => setPropertySubType(e.target.value)} className="form-control shadow-none form-control-lg selectpicker rounded-right-md-0 rounded-md-top-left-0 rounded-lg-top-left flex-md-1 mt-3 mt-md-0"
                  ...
                  name="type">
                  <option value={""} >Slecet Property Type</option>
                ...
                {/* <select value={CountyOrParish} onChange={(e) => setCountyOrParish(e.target.value)} className="form-control border-0 shadow-none form-control-lg selectpicker bg-white"
                  title="All Cities" data-style="btn-lg py-2 h-52 bg-white" name="city">
                  <option value={""} >Slecet County Type</option>
                  {
                    allCounties?.data?.map((value) => {
              ...
              <div id="advanced-search-filters-2" className="col-12 pb-6 pt-lg-2 collapse" data-parent="#accordion-2">
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 col-lg-5 pt-6 slider-range slider-range-primary offset-lg-1">
                    ...
                    <div className="text-center mt-2">
                      <input id="area-size-2" type="text"
                        className="border-0 amount text-center text-white bg-transparent font-weight-500"
                        name="area" />
                    </div>
                  </div>
          ...
          <form className="property-search property-search-mobile d-lg-none py-6">
            <div className="row align-items-lg-center" id="accordion-2-mobile">
              ...
              <div id="advanced-search-filters-2-mobile" className="col-12 pt-2 collapse"
                ...
                <div className="row">
                  <div className="col-md-6 pt-6 slider-range slider-range-primary">
                    ...
                    <div data-slider="true"
                      data-slider-options='{"min":0,"max":1000000,"values":[100000,700000],"type":"currency"}'></div>
                    <div className="text-center mt-2">
                      <input id="price-2-mobile" type="text"
                        className="border-0 amount text-center text-white bg-transparent font-weight-500"
                        name="price" />
                    </div>
                  </div>
                  <div className="col-md-6 pt-6 slider-range slider-range-primary">
                    ...
                    <div className="text-center mt-2">
                      <input id="area-size-2-mobile" type="text"
                        className="border-0 amount text-center text-white bg-transparent font-weight-500"
                        name="area" />
                    </div>
                  </div>
                  ...
                  <div className="collapse row mx-0 w-100" id="other-feature-2-mobile">
                    ...
                    <div className="col-sm-6 py-2">
                      <div className="custom-control custom-checkbox">
                        ...
                        <label className="custom-control-label text-white"
                          htmlFor="check5-2-mobile">Barbeque</label>
                      </div>
                    </div>
                    <div className="col-sm-6 py-2">
                      <div className="custom-control custom-checkbox">
                    ...
                    <div className="col-sm-6 py-2">
                      <div className="custom-control custom-checkbox">
                        ...
                        <label className="custom-control-label text-white"
                          htmlFor="check10-2-mobile">Microwave</label>
                      </div>
                    </div>
                    <div className="col-sm-6 py-2">
                      <div className="custom-control custom-checkbox">
                    ...
                    <div className="col-sm-6 py-2">
                      <div className="custom-control custom-checkbox">
                        ...
                        <label className="custom-control-label text-white"
                          htmlFor="check16-2-mobile">Refrigerator</label>
                      </div>
                    </div>
                  </div>
                </div>
